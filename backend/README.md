...
## Project Structure
    ...
    ├── innovation_network__38287  # Django project configurations
...
1. Clone this repo and `cd innovation_network__38287`
...
2. Clone this repo and `cd innovation_network__38287`
